...
public:
	...
	void print()const
	{
		Element* Temp = Head;     //Temp - это итератор. Итератор - это указатель, при помощи которого можно перебирать элементы структуры данных. 
		while (Temp)
		{
		...
		Temp;	//Указатель 'Temp';
		//Temp->;	//Элемент 'Temp';
		cout << "Количетсво элементов списка: " << Element::count << endl;
	}
};
